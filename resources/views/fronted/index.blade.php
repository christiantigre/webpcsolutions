...
<head>
    ...
    <!-- Google Font 
    <link href="{{ asset('thema/fonts/font.css') }}" rel='stylesheet' type='text/css'>-->
...
form textarea:focus {
  ...
  border-color: {{ $prop->sectioncolor  }};
}
label {
  font-weight: normal;
}
...
.lightbox-loading {
  background: url({{ asset('thema/images/loading.gif')  }}) center center no-repeat;
  width: 31px;
  height: 31px;
...
.lightbox-close {
  right: 10px;
  top: 10px;
  background-image: url({{ asset('thema/images/close.png')  }});
}
.lightbox-next {
  right: 10px;
  top: 48%;
  background-image: url({{  asset('thema/images/next.png') }});
}
.lightbox-previous {
  left: 10px;
  top: 48%;
  background-image: url({{ asset('thema/images/previous.png')  }});
}
/* ==========================================================================
   Print styles
   ========================================================================== */
...
.navbar-default .navbar-toggle {
  border-color: transparent;
  margin-top: 40px;
  /*color: {{ $prop->colortext1  }} ; */ /*#fff*/
  /*#f55858*/
  background-color: {{ $prop->sectioncolor  }};
  font-size: 18px;
}
...
.logo-wrapper .logo-s {
  ...
  right: 0;
  top: 0;
  background: url({{ asset('thema/images/logo-s.png')  }}) no-repeat;
  margin-right: -99px;
  margin-top: -19px;
  width: 122px;
  height: 122px;
...
#main-menu ul .nav-s {
  ...
  left: 0;
  top: 0;
  background: url({{ asset('thema/images/nav.png')  }}) no-repeat;
  margin-left: -99px;
  margin-top: -23px;
  width: 122px;
  height: 122px;
...
/*** PRODUCT STYLING ***/
#products {
  background: url({{ asset('thema/images/bg1.png')  }}) no-repeat center top;
...
#bottom-section {
  background: url({{ asset('thema/images/bg2.png')  }}) no-repeat center top;
  background-size: cover;
  padding-top: 300px;
  margin-top: -320px;
}
